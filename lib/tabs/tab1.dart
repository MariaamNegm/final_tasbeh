                    ...
                    child: Column(
                      ...
                      children:[
                        ...
                        FlatButton(
                          ...
                          Text("سبح",style: TextStyle(fontSize:fontsize-10,color:Colors.white),textAlign:TextAlign.center,)
                          ),
                        // abutton to press to increament
                        SizedBox(height:10),
                        //make the space between
                        ...
                        Text("تصفير",style: TextStyle(fontSize:fontsize-10,color:Colors.white),textAlign:TextAlign.center,)
                        ),
